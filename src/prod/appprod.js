...
var _issues = __webpack_require__(67);
...
function reducer(state, action) {
    ...
    return {
        counter: (0, _counter2.default)(state.counter, action),
        issues: (0, _issues2.default)(state.issues, action),
...
var store = (0, _redux.createStore)(reducer, { counter: 0, issues: [], repository: '' });
...
exports.default = function (stateCounter, action) {
    switch (action.type) {
        case 'INCREMENT_COUNTER':
...
exports.default = function (stateIssues, action) {
    switch (action.type) {
        case 'ISSUES_LOAD':
